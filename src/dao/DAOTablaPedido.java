...
public class DAOTablaPedido {
	...
	private ProductoSingular getMasVendido(String dia) throws Exception {
		...
		ProductoSingular prod=new ProductoSingular(rs.getInt("IDPRODUCTO"), rs.getString("NOMBRE"), rs.getString("DESCRIPCIONESPA—OL"), rs.getString("DESCRIPCIONINGLES"),cat );
		return prod;
	}
